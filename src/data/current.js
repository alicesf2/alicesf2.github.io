export const learningPanels = [
  {
    ...
    content:
      "we live in a world with seemingly endless amounts of data. what's the best way to display this information in a format that is easily processed by the human brain?"
  }
];
...
export const devPanels = [
  {
    key: "research",
    title: "classtranscribe research 💡",
    content:
      "how can we make online learning more engaging and accessible? working with angrave on improving the frontend of an online lecture platform using react."
  }
];
...
export const watchPanels = [
  ...
  },
  {
    ...
    content:
      "some of the most beautiful, breath-taking, and awe-inspiring moments happen in the blink of an eye. it's amazing to be able to capture these moments and see them clearly with the help of a camera."
  }
];
...
export const listenPanels = [
  {
    ...
    title: "feather 🦢",
    content:
      "the ultimate lo-fi hip-hop song. first heard of from kevjumba during a game of password on higatv. listening to this song with the context of nujabes' premature death is saddening yet somehow liberating."
  },
  {
    key: "bored",
